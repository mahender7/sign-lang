...
while True:
    ...
    cv2.putText(frame, "SEVEN : "+str(count['seven']), (10, 230), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    cv2.putText(frame, "EIGHT : "+str(count['eight']), (10, 230), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    cv2.putText(frame, "NINE : "+str(count['nine']), (10, 230), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
